...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
      SQL is the Structured Query Language, it is the standardized programing language to manage relational databases. A relational database is a set of tables that data can be accesses or reassembled.
- [ ] Why do tables need a `primary key`?
      A primary key is a filed in a table which uniquely identifies each row/recode in a database table
